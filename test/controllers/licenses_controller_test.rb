...
class LicensesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create license" do
    assert_difference('License.count') do
      post licenses_url, params: { license: { expiration_date: @license.expiration_date, price: @license.price, product_id: @license.product_id, user_id: @license.user_id } }
    end
  ...
  test "should update license" do
    patch license_url(@license), params: { license: { expiration_date: @license.expiration_date, price: @license.price, product_id: @license.product_id, user_id: @license.user_id } }
